  ...
  public init(from decoder: Decoder) throws {
    ...
    self.ingredientMeasures = {
      let strIngredients = container.allKeys
        ...
        .compactMap { try? container.decodeIfPresent(String.self, forKey: $0)?.trimmingCharacters(in: .whitespacesAndNewlines) }
        .filter { !$0.isEmpty }
...
extension ApiClient.MealDetails {
  public static let previewValue = ApiClient.MealDetails(
    idMeal: "52855",
